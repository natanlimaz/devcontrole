...
export function ModalTicket() {
    ...
    return (
        <div className="absolute w-full min-h-screen bg-gray-900/80" onClick={handleModalClick}>
            <div className="absolute inset-0 flex items-center justify-center">

                <div  ref={modalRef} className="bg-white shadow-lg w-4/5 md:2-1/2 max-w-2xl p-3 rounded">
